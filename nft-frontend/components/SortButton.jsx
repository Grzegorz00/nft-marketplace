...
export default function SortButton({ setSort }){
    ...
    return(
            <div className='group'>
                <button 
                    className='rounded-3xl text-lg bg-transparent border-2 border-indigo-300 px-5 h-10 flex items-center text-indigo-300 group-hover:bg-indigo-50 group-hover:text-indigo-500 duration-50'
