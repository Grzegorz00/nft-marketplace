    ...
    return(
            <div className='group z-9'>
                ...
                <div className={`absolute w-185 grid bg-indigo-50 rounded-xl text-lg mt-1 p-2 border-indigo-300 border-2 text-indigo-500 ${activeDrop ? '' : 'hidden'}`}>
                    ...
                    <button className='text-left px-2 py-1 border-b-2 border-indigo-300 hover:bg-white' onClick={(event) => handleClick(event, "Low to High")}> Low to High</button>
                    <button className='text-left px-2 py-1 hover:bg-white border-b-2 border-indigo-300' onClick={(event) => handleClick(event, "High to Low")}> High to Low</button>
                    <span className='px-2 py-1 border-b-2 border-indigo-300 font-bold'>By Name</span>
                    <button className='text-left px-2 py-1 hover:bg-white border-b-2 border-indigo-300' onClick={(event) => handleClick(event, "A-Z")}> A-Z</button>
                    <button className='text-left px-2 py-1 hover:bg-white' onClick={(event) => handleClick(event, "Z-A")}> Z-A</button>
                </div>
