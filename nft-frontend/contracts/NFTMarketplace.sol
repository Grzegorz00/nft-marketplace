// SPDX-License-Identifier: UNLICENSEDingPrice
...
contract NFTMarketplace is ERC721URIStorage {
    ...
    modifier onlyOwner() {
        require(
            msg.sender == owner,
            "only owner of the marketplace can change the listing fee"
        );
        //    _;    it runs the function after checking requirments
        _;
    }

    constructor() ERC721("Non-Fungible Tokens", "NFTs") {
